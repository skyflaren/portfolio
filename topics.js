...
function searchSort(){
    ...
    code1.innerHTML = '<code>public class Main {\n\tpublic static void main(String[] args) {\n\t\tint arr [] = {1, 5, 8, 12, 38, 42, 57, 89};\n\t\tint searchedValue = 37;\n\t\tfor(int lo = 0, hi = arr.length, mid = (lo+hi)/2; lo < hi; mid = (lo+hi)/2){\n\t\t\tif(arr[mid] < searchedValue) lo = mid+1;\n\t\t\telse if(arr[mid] > searchedValue) hi = mid;\n\t\t\telse{\n\t\t\t\tSystem.out.println(mid);\n\t\t\t\treturn;\n\t\t\t}\n\t\t}\n\tSystem.out.println("Value not found");\n\t}\n}</code>';
